...
async def set_price_based_charging(
    ...
    # minimum_pct = service_call.data["minimum_percentage"]
    #
    # device = dr.async_get(hass).devices[device_id]
    # evse_id = next(
...
async def update_price_based_charging(
    ...
    #
    # current_battery_percentage = service_call.data["current_percentage"]
    #
    # device = dr.async_get(hass).devices[device_id]
    #
    # evse_id = next(
    ...
    # )
    #
    # get_current_smart_charging_profile(charge_points[evse_id])
